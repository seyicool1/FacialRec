...
st.markdown("<h6 style = 'top_margin: 0rem; color: #F2921D'>Built by SEYI OLORUNHUNDO</h6>", unsafe_allow_html = True)

# Add an image to the page
st.image('WhatsApp Image 2024-02-20 at 14.55.08_bd76f243.jpg', caption = 'FACE DETECTOR', width = 400)
